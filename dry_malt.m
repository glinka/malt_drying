...
function dry_malt()
  ...
  air_prog_table = uitable(program_panel, 'Position', [20, 50, 490, 80],...
  ...
  stop_time_table = uitable(program_panel, 'Position', [555, 10, 78, 40],...
			    'Data', [25],...
